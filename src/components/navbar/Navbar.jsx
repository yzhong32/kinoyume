        ...
        <Styled.StyledNavBar>
                <Flex justifyContent='space-around' marginBottom={'40px'}>
                    ...
                    <Flex justifyContent='space-around' marginRight='6%'>
                        ...
                        <PageItem active={currentPage === 2} done={currentPage !== 2} onClick={() => handleStepClick(2)}>
                            MENU & ORDER
                        </PageItem>
                        <PageItem active={currentPage === 3} done={currentPage !== 3} onClick={() => handleStepClick(3)}>
                            RESERVATION
                        </PageItem>
                        <PageItem active={currentPage === 4} done={currentPage !== 4} onClick={() => handleStepClick(4)}>
                            OUR STORY
                        </PageItem>
                        <PageItem active={currentPage === 5} done={currentPage !== 5} onClick={() => handleStepClick(5)}>
                            CAREERS
                        </PageItem>
                    </Flex>
                </Flex>
